    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       try{
        ...
        if (accion.equalsIgnoreCase("Registrar")){
            if(ProductoCad.registrarProducto(p, usd).equals("SI")){
                request.setAttribute("mensaje", "<p style='color:green'> Producto registrado");   
            } else if(ProductoCad.registrarProducto(p, usd).equals("NO")){
                request.setAttribute("mensaje", "<p style='color:red'>Producto no registrado");
            }
            else if(ProductoCad.registrarProducto(p, usd).equals("SQLERROR")){
                request.setAttribute("mensaje", "<p style='color:red'>Error en la base de datos");
            }
        }else{
            
            request.setAttribute("mensaje", "<p style='color:red'>Accion desconocida");
