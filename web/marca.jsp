...
<html>
    ...
    <body>
        ...
        <%! String tituloMarca;%>
        <%            
            String nombreMarca = request.getParameter("brand");
            try{
                codMarca = Integer.parseInt(nombreMarca);
            }
            catch(NumberFormatException ex){
                codMarca = 0;
            }
            tituloMarca = MarcaCad.obtenerMarca(codMarca).getNombre();
                        
        %>
        <div class="container">
            <div class="col-sm-12 padding-right">
                <div class="features_items"><!--features_items-->
                    <h2 class="title text-center"><%out.print(tituloMarca);%></h2>
                    <%! ArrayList<Producto> datos;%>
                    <%
                        if (codMarca > 0) {
                            datos = ProductoCad.listarProductosPorMarca(session.getAttribute("moneda").toString(), codMarca);
                        } else {
